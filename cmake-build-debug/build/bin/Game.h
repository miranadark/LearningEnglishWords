...
string qNormalGameOne[] = {"daugh",
                           ...
                           "chim",
                           "wardr"};
string aNormalGameOne[] = {
        "ter", "ant", "ing", "ity", "age", "tal", "ain", "oom", "ney", "obe"};
string qHardGameOne[] = {"strawb",
                         "vegeta",
                         "waterm",
                         "pinea",
                         "handkerc",
...
string aEasyGameTwo[] = {"lamp",
                         ...
                         "word",
                         "grey"};
string qNormalGameTwo[] = {"беспокоить-",
                           "глупый-",
                           "опасность-",
                           "выбор-",
                           "воздушный шар-",
